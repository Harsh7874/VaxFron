    ...
    <div>
      ...
      <div className='sm:ml-72 sm:pl-4 mt-8 font-medium text-[#565656]'>
        ...
        <button
          ...
          className='bg-primary text-white text-sm font-light px-20 py-3 rounded-full my-6 flex items-center justify-center gap-2 disabled:opacity-50'
          disabled={isBooking}
        >
          {isBooking ? (
            <>
